...
import { getWarehouseInboundDeliverableFile } from "@/services/deliverables/get-warehouse-inbound-deliverable-file";
...
export async function GET(_request: NextRequest, context: RouteContext) {
  try {
    ...
    const result = await getWarehouseInboundDeliverableFile(id);
    ...
    logRouteError(error, {
      route: "/api/warehouse-inbound-deliverables/[id]/download",
      method: "GET",
    });
