...
import { getWarehouseInboundSummary } from "@/services/deliverables/list-warehouse-inbound-rows";
...
export default async function CoupangGrowthInboundPage({
  ...
  const warehouseInboundList = sellerId
    ? await getWarehouseInboundSummary({ coupangSellerAccountId: sellerId })
    : { snapshotDates: null, rowCount: 0 };
